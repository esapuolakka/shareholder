...
public interface ShareTransactionRepository extends JpaRepository<ShareTransaction, Long> {
    ...
    List<ShareTransaction> findBySellerFirstnameContainingIgnoreCaseOrSellerLastnameContainingIgnoreCase(
            String firstname, String lastname);

    List<ShareTransaction> findByStatus(String status);

    List<ShareTransaction> findByBuyerIdOrSellerId(Long buyerId, Long sellerId);
}
